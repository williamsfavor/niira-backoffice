...
export type DashboardData = {
  ...
  applications: Array<{ application_id: string; applicant_name: string | null; application_type: string | null; status: string; current_stage: string | null; last_update: string | null }>;
