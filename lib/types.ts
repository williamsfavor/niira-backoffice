...
export type DashboardData = {
  ...
  recentTickets: Array<{ ticket_id: string; issue_text: string; status: TicketStatus; created_at: string; phone_number: string; resolutionNotification: { status: string; delivery_status: string | null; attempts: number; last_error: string | null } | null }>;
  ...
  appointmentSlots: Array<{ id: string; slot_reference: string; starts_at: string; is_active: boolean; centers: { name: string } | null }>;
};
